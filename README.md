...
```gradle
dependencies {
    implementation 'io.github.robertomike:baradum:1.0.0'
}
```
...
dependencies {
    // Spring boot 2
    implementation 'io.github.robertomike:baradum-apache-tomcat-9:1.0.0'
    // Spring boot 3
    implementation 'io.github.robertomike:baradum-apache-tomcat-10:1.0.0'
}
```
